...
export default function Page() {
    ...
    return (
        <main style={{ display: 'flex', flexDirection: 'column', height: 667, width: 376, margin: 'auto' }}>
            <Header title = "Events"/>
            <div className="mx-4 py-4 flex gap-4 flex-col">

                <div className="flex justify-center">
                    <button onClick={() => setNewEvent(true)} className="border-2 text-center border-slate-950 rounded-md w-full p-1 text-black flex flex-row items-center center text-center">
                    ...
                    <div className="">
                        <div className="flex flex-col gap-2 bg-amber-100 rounded-lg drop-shadow-lg p-4">
                            <div className="flex flex-row items-center gap-2">
                                ...
                                <input className="py-1 w-full rounded-lg bg-amber-100 text-sm text-black" type="text"
                            ...
                            <div
                                ...
                                <input className="w-4/5" type="text" placeholder="Date and Time"
                                       onChange={dateTimeChangeHandler} value={dateTime}></input>
                            </div>
                            <div
                                className="w-full bg-white py-1 pl-4 rounded-full drop-shadow-md flex flex-row gap-2 text-black border-2 border-black">
                                <EditIcon/>
                            ...
                            <div
                                ...
                                <input className="w-4/5" type="text" placeholder="Description"
                                       onChange={descriptionChangeHandler} value={description}></input>
                            </div>
