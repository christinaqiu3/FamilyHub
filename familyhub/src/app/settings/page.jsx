...
function GroupSettings() {
    ...
    return (
        <div className='flex py-2 flex-column hover:bg-gray-200 rounded-md ml-auto my-2'
...
export default function SettingsPage() {
    ...
    function ColorButton({colorStyle, colorLightString, colorMedString, colorDarkString}) {
        return (
            <button className='color-button drop-shadow-md' style={colorStyle}
                    onClick={() => setColor({colorLightString, colorMedString, colorDarkString})}></button>
        )
    }
    ...
    function BorderButton({colorStyle, colorString}) {
        return (
            <button className='color-button' style={colorStyle} onClick={() => {
    ...
    return (
        <main>
            ...
            <div id="content" className="pb-8">
                {colorActive && (
                    <div
                        className='bg-gray-100 rounded-lg drop-shadow-xl absolute mt-44 z-20 p-4 ml-4 items-center flex flex-col gap-4'>
                        ...
                        <div className='flex flex-col gap-3'>
                            <div className='flex flex-row gap-4'>
                                ...
                                />
                                <ColorButton colorStyle={{backgroundColor: '#ffc291'}}
                                             colorLightString='#ffe2ca'
                                             colorMedString='#ffc291'
                                             colorDarkString='#fa9a4b'
                                />
                                <ColorButton colorStyle={{backgroundColor: '#ff9bb0'}}
                                             colorLightString='#ffd1da'
                                             colorMedString='#ff9bb0'
                                             colorDarkString='#f26582'
                                />
                                <ColorButton colorStyle={{backgroundColor: '#ff91ce'}}
                                             colorLightString='#ffcae7'
                                             colorMedString='#ff91ce'
                                             colorDarkString='#f654ae'
                                />
                                <ColorButton colorStyle={{backgroundColor: '#e89dff'}}
                                             colorLightString='#f4ceff'
                                             colorMedString='#e89dff'
                                             colorDarkString='#d55cfa'
                                />
                            </div>
                            <div className='flex flex-row gap-4'>
                                <ColorButton colorStyle={{backgroundColor: '#a18dfc'}}
                                             colorLightString='#cdc2ff'
                                             colorMedString='#a18dfc'
                                             colorDarkString='#8a72f8'
                                />
                                <ColorButton colorStyle={{backgroundColor: '#8dc0fc'}}
                                             colorLightString='#cae2ff'
                                             colorMedString='#8dc0fc'
                                             colorDarkString='#5f9ee9'
                                />
                                <ColorButton colorStyle={{backgroundColor: '#9ae0f6'}}
                                             colorLightString='#c8f2ff'
                                             colorMedString='#9ae0f6'
                                             colorDarkString='#71d2f0'
                                />
                                <ColorButton colorStyle={{backgroundColor: '#8bf2cf'}}
                                             colorLightString='#bef8e5'
                                             colorMedString='#8bf2cf'
                                             colorDarkString='#5de5b7'
                                />
                                <ColorButton colorStyle={{backgroundColor: '#bceb70'}}
                                             colorLightString='#e1faba'
                                             colorMedString='#bceb70'
                                             colorDarkString='#a2eb2d'
                                />
                            </div>
                        </div>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <button className="p-3 border border-black rounded-full hover:bg-gray-200">
                                    <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M6.25174 9.07828L3.883 8.2887C1.40258 7.46189 0.162354 7.04848 0.162354 6.28876C0.162354 5.52903 1.40257 5.11562 3.88301 4.28881L12.8564 1.29768C14.6017 0.715908 15.4744 0.425024 15.935 0.885666C16.3957 1.34631 16.1048 2.21896 15.523 3.96427L12.5319 12.9377C11.7051 15.4181 11.2916 16.6583 10.5319 16.6583C9.7722 16.6583 9.35879 15.4181 8.53198 12.9377L7.7424 10.5689L12.3313 5.98003C12.743 5.56839 12.743 4.901 12.3313 4.48936C11.9197 4.07772 11.2523 4.07772 10.8407 4.48936L6.25174 9.07828Z"
                                            fill="#222222"/>
                                    </svg>
                                </button>
                            </div>
