...
function Poll({question, option1, option2}) {     
    ...
    function Option1Selected() {
        return (
            <div className="w-full bg-amber-500 px-4 py-1 rounded-full drop-shadow-md text-gray-900 text-left flex flex-row justify-between">
                {option1}
                        ...
                        <div class=""> 
                            <div className="flex flex-col gap-2 bg-amber-100 rounded-lg drop-shadow-lg p-4">
                                <div className="flex flex-row items-center gap-2">
                                    ...
                                    <input className="py-1 w-full rounded-lg bg-amber-100 text-sm" type="text" placeholder="Set your prompt..." onChange={questionChangeHandler} value={question}></input>
                                </div>
